...
client
```
sudo ./build/app/dpdk-testpmd -l 0-19 -n 4 -a 3d:00.1 -a 3d:00.0 --socket-mem=4096,0,0,0 -- --socket-num=0 --burst=64 --txd=4096 --rxd=4096 --mbcache=512 --rxq=19 --txq=19 --nb-cores=19 -i -a --rss-ip --no-numa --forward=txonly --txonly-multi-flow --txpkts=64
```
